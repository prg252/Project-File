...
namespace FlightApp
{
    public partial class Form1 : Form
    {
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (counter==1)
            {
                ResultsForm resultsForm = new ResultsForm(1);
                resultsForm.Show();
                this.Hide();
            ...
            {
                ResultsForm resultsForm = new ResultsForm(3);
                resultsForm.Show();
                this.Hide();
            }
            else if (counter==4)
            {
                ResultsForm resultsForm = new ResultsForm(4);
                resultsForm.Show();
                this.Hide();
            }
            else if (counter==7)
            {
                ResultsForm resultsForm = new ResultsForm(7);
                resultsForm.Show();
                this.Hide();
            }
            else if (counter==8)
            {
                ResultsForm resultsForm = new ResultsForm(8);
                resultsForm.Show();
                this.Hide();
            }
